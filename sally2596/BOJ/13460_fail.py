...
que = deque([[red_i, red_j, blue_i, blue_j, 0, 0, 0, 0]])
...
fin = 0
while (que):
    ri, rj, bi, bj, previ, prevj, dir, cnt = que.popleft()
    visited[previ][prevj][dir] = 1
    if fin == 1:
        break
    if cnt + 1 > 10:
        print(-1)
    ...
    for k in range(4):
        ...
        if board[nextbi][nextbj] != "O":
            ...
            if visited[nextri][nextrj][k] == 0:
                que.append([nextri, nextrj, nextbi, nextbj, ri, rj, k, cnt + 1])
if fin == 0:
    print(-1)
